...
if len(sys.argv)!=6:
    ...
    for filename in os.listdir(image_dir_input):
        ...
        if os.path.isfile(f_output):
            ...
            f0 = image_dir_output + filename + '.png'
            ...
            cmd0 = 'gm convert %s -format png -bordercolor black -border 1x1 -fuzz %i%% -trim +repage -gravity center -resize %i -background black -gravity center -extent %ix%i %s\n' % (f_input, fuzz,scale, scale, scale, f0)
